...
export default class MiniCart extends React.Component {
    ...
    closeCart(event) {
        if (this.state.cartOpen && !event.target.className.includes('cart-element')){
            this.setState({
                cartOpen: false
            })
        }
                ...
                <div className="minicart-wrapper">
                    ...
                    <div className={ this.state.cartOpen ? "minicart__droplist-wrapper cart-element" : "hiddenObj" }>
                        ...
                        <div className="minicart__total-wrapper cart-element">
                            ...
                            <p className="minicart__total-result cart-element">$200</p>
                        </div>
                        <div className="minicart__buttons-wrapper cart-element">
                            <button className="minicart__button-viewbag cart-element">VIEW BAG</button>
                            <button className="minicart__button-checkout cart-element">CHECK OUT</button>
                        </div>
                    </div>
                </div>
            </>
