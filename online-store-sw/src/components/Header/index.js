            ...
            <header>
                <nav>
                    ...
                    <div className="header-details">
                        <div className="header-details-currency">
                            <p className="currency-symbol">$</p>
                            <svg className="currency-chevron-icon" width="8" height="4" viewBox="0 0 8 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 0.5L4 3.5L7 0.5" stroke="black" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </div>
                        <div className="header-details-cart">
                            <svg className="cart-icon" width="20" height="19" viewBox="0 0 20 19" fill="#43464E" xmlns="http://www.w3.org/2000/svg">
